...
# Create project
create_project ders42 ./ders42 -part xc7a100tcsg324-1
...
set files [list \
 "[file normalize "$origin_dir/board.prj"]"\
]
add_files -norecurse -fileset $obj $files

source $origin_dir/ublaze.tcl
...
set obj [get_filesets sources_1]
set_property "top" "ublaze_wrapper" $obj
...
puts "INFO: Project created:ders42"
